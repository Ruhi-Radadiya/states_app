    ...
    MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(backgroundColor: Color(0xffD7CCC8),
          title: const Text("STATES", style: TextStyle( color: Colors.red,fontWeight: FontWeight.w600),),
          centerTitle: true,
        ),
        body: Center(
          child: RichText(
            text: const TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(text:"Andra Pradesh\n",style: TextStyle(color: Colors.deepOrange,fontWeight: FontWeight.w300),),
                  ...
                  TextSpan(text:"Himachal Pradesh\n",style: TextStyle(color: Color(0xff774444),fontWeight: FontWeight.w400),),
